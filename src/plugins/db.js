...
exports["default"] = fastify_plugin_1["default"](function (server) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                server.decorate("db", {
                    coupon: connection.getRepository(coupon_1.coupon)
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
